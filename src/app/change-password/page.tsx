...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="max-w-sm mx-auto p-6 space-y-3">
      {sp.get("first") && (
        <p className="text-sm text-muted-foreground">Debés cambiar tu contraseña antes de continuar.</p>
      )}
      ...
      <Button onClick={submit} disabled={loading || pwd.length < 6 || cur.length < 1}>Guardar</Button>
    </div>
  );
}
