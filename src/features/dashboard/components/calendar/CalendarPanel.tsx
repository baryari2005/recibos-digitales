...
import { useMonthHolidays } from "../../hooks/calendar/useMonthHolidays";
import { useMonthBirthdays } from "../../hooks/calendar/useMonthBirthdays";
import { format as fmt } from "date-fns";
import { DayDetailsSheet } from "./DayDetailsSheet";
import { Bday } from "./DayDetailsDialog";
...
export function CalendarPanel() {
  ...
  const { birthdaySet, birthdaysByDate } = useMonthBirthdays(month);
